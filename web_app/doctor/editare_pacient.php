...
<head>
	...
	<nav class="navbar navbar-expand-md navbar-dark bg-primary" style="height:60px;">
		 ...
		 <?php 
			...
			<img src="<?php echo $nume_poza;?>" title="<?php echo $prenume;?>"alt="Avatar" class="avatar" style="width:40px;height:40px;border-radius: 50%;margin-left:10px;">
	</nav>
		...
		<div class="card-body" style="font-size:26; background-color: #ccccb3">
			<form action="action_edit_patient.php" method = "post">
				...
				<div class="right">
					...
					<input type="date" name="data_nastere" value="<?php echo $data_nastere;?>">
