...
<head>
	...
	<span ><?php 
	   ...
	   echo '<a class="btn btn-info bg-primary" style="margin-left:1310px;" href="adaugare_vaccin.php?' . $items_add . '" class="btn btn-success">Adaugare Vaccin</a>';
	   echo '<a  class="btn btn-info bg-primary" href="aviz_epidemiologic.php?' . $items_add . '"  class="btn btn-success"  style="margin:0px 0px 0px 10px;" >Export pdf</a><br>';?></span>
	</div>
</head>
					...
					if(mysqli_num_rows($results) > 0 ){
						while($row = mysqli_fetch_assoc($results)){?>
							<tr>
								...
								echo '<a href="edit_action_vaccin.php?' . $items_edit . '"
								...
								$items = implode('&', $files);
								echo '<a href="delete_action_vaccin.php?' . $items . '" class="btn btn-danger">Ștergere</a>';
