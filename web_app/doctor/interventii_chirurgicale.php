...
<head>
	...
	<span ><?php 
	   ...
	   echo '<a class="btn btn-info bg-primary" style="margin-left:1410px;" href="adaugare_interventii_chirurgicale.php?' . $items_add . '" class="btn btn-success">Adaugare intervenție</a>';?></span>
	</div>
</head>
...
<div class="container mb-3 mt-3">
	...
	<thead>
		<tr>
		  ...
		  <th scope="col" style="width:200px;">Actiuni</th>
		</tr>
	</thead>
	<tbody>
		<?php
			...
			if(isset($_POST['update_interventie'])){
				...
				$query_update = "UPDATE interventii_chirurgicale SET data='$data',denumire='$denumire',recomandari='$recomandari', spital='$spital' WHERE id= $id";
						...
						<tr>
							...
							<td>
							 ...
							 <?php 
								...
								echo '<a href="edit_action_interventii_chirurgicale.php?' . $items_edit . '"
								...
								$items = implode('&', $files);
								echo '<a href="delete_action_interventii_chirurgicale.php?' . $items . '" class="btn btn-danger">Ștergere</a>';
