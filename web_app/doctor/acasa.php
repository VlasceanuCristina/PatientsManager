...
@media only screen and (max-width: 600px) {
  .spatiu {
	...
	<body style="background-image:url('doctori.jpg'); background-repeat:no-repeat; object-fit: cover;">
		...
		<nav class="navbar navbar-expand-md navbar-dark bg-primary" style="margin-left:auto;margin-right:auto;">
			...
			<a class="navbar-brand" href="#">
				...
				?>
				<a class="spatiu" style="margin-left:1150px;"></a>
			...
			<div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
				...
				<ul class="list-group">
					...
					<div id='submenu1' class="collapse sidebar-submenu">
						<a href="afisare_pacienti.php?medic=<?php echo $id_medic;?>" class="list-group-item list-group-item-action bg-dark text-white">
							<span class="menu-collapsed" style="font-size:16px;">Afișare pacienți</span>
						</a>
						<a href="adaugare_pacient.php?medic=<?php echo $id_medic;?>" class="list-group-item list-group-item-action bg-dark text-white">
							<span class="menu-collapsed" style="font-size:16px;">Adăugare pacienți </span>
						</a>
						<a href="pacienti_covid.php?medic=<?php echo $id_medic;?>" class="list-group-item list-group-item-action bg-dark text-white">
							<span class="menu-collapsed" style="font-size:16px;">Listă pacienți COVID-19 </span>
						</a>
					...
					<div id='submenu2' class="collapse sidebar-submenu">
						<a href="profilul_meu.php?medic=<?php echo $_GET['medic']; ?>" class="list-group-item list-group-item-action bg-dark text-white">
							<span class="menu-collapsed" style="font-size:16px;">Profilul meu</span>
						</a>
						<a href="setari_parola.php?medic=<?php echo $_GET['medic']; ?>" class="list-group-item list-group-item-action bg-dark text-white">
					...
					<a href="afisare_programari.php?medic=<?php echo $id_medic;?>" class="bg-dark list-group-item list-group-item-action">
						<div class="d-flex w-100 justify-content-start align-items-center">
							...
							<span class="menu-collapsed" style="font-size:20px;">Programări</span>
						</div>
					</a>
					<a href="#submenu4" data-toggle="collapse" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
						<div class="d-flex w-100 justify-content-start align-items-center">
							<span class="fa fa-user fa-fw mr-3"></span>
							<span class="menu-collapsed" style="font-size:20px;">Rapoarte</span>
							
						</div>
					</a>
					<!-- Submenu content -->
					<div id='submenu4' class="collapse sidebar-submenu">
						<a href="raport_incasari.php?medic=<?php echo $_GET['medic']; ?>" class="list-group-item list-group-item-action bg-dark text-white">
							<span class="menu-collapsed" style="font-size:16px;">Raport încasări</span>
						</a>
						<a href="evidenta_pacienti.php?medic=<?php echo $_GET['medic']; ?>" class="list-group-item list-group-item-action bg-dark text-white">
							<span class="menu-collapsed" style="font-size:16px;">Evidență pacienți</span>
							
						</a>
						<a href="evidenta_covid.php?medic=<?php echo $_GET['medic']; ?>" class="list-group-item list-group-item-action bg-dark text-white">
							<span class="menu-collapsed" style="font-size:16px;">Evidență COVID-19</span>
						</a>
					</div>
