...
<head>
	...
	<title >Adaugare internare</title>
	<?php
		session_start();
		if(isset($_GET['files'])){
...
<style>
	...
	input  { width: 300px;            height: 45px;      box-sizing:border-box;margin:10px 0px 20px 0px; }
	select { width: 300px;            height: 48px;      box-sizing:border-box;margin:0px 0px 20px 0px;}
	</style>
...
<div class = "card"  style="margin:100px 300px 300px 300px; width:1000px;opacity:0.9;">
	<div class = "card-header" style="background-color:#0275d8;">
		<center><h2>Adăugare internare</h2><center>
	</div>
	<div class = "card-body" style="font-size:26; background-color:#ccccb3;">
			<form method="post" action="adaugare_internare_action.php">
				<div class="left">
				...
				<div class="right">
					<input type= "text" name = "spital">
					<input type= "text" name = "tratament">
					<input type= "date" name = "data_internare"> 
					<input type= "date" name = "data_externare"> 
					<input type= "text" name = "diagnostic_internare">
					<input type= "text" name = "diagnostic_externare">
					
					<?php if(isset($_GET['files'])){?>
					<input type="hidden" name="identificare" value=<?php echo $items_add;?>>
					<?php }?>
					<input type="submit" name = "adaugare_internare" class="btn btn-success" style = " width: 100px;height:40px;text-align: center;" value = "Adauga"/>
				</div>
