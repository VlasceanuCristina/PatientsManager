...
<head>
	...
	<title >Adugare interventii chirurgicale</title>
	<?php
		session_start();
		if(isset($_GET['files'])){
...
<div class = "card"  style="margin:150px 300px 300px 300px; width:1000px;opacity:0.9;">
	<div class = "card-header" style="background-color:#0275d8;">
		<center><h2>Adăugare intervenție chirurgicală</h2><center>
	</div>
	<div class = "card-body" style="font-size:26; background-color:#ccccb3;">
		<form method="post" action="adaugare_interventii_chirurgicale_action.php">
			<div class="left">
				<span>Denumire:</span>
				<span>Data:</span>
			...
			<div class="right">
				<input type="hidden" id="id_pacient" name="id_pacient" value="<?php echo $id_pacient;?>"> 
				<input type= "text" name = "denumire">
				<input type= "date" name = "data">
				<input type= "text" name = "spital">
				<input type= "text" name = "recomandari">
				<?php if(isset($_GET['files'])){?>
				<input type="hidden" name="identificare" value=<?php echo $items_add;?>>
				<?php }?>
				<input type="submit" name = "adaugare_interventie" class="btn btn-success" style = " width: 100px;height:40px;text-align: center;"value = "Adauga"/>
			</div>
	</div>
</div>
</body>
