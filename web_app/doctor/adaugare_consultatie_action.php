...
elseif(!is_null($id_adeverinta))
	$query="INSERT INTO consultatii(id_pacient,data,ora, tratament,diagnostic,comentarii,pret,id_adeverinta) VALUES($id_pacient,'$data','$ora','$tratament','$diagnostic','$comentarii',$pret,$id_adeverinta)";
else
