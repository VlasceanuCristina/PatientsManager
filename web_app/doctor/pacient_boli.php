...
<head>
	...
	<span ><?php 
	   ...
	   echo '<a class="btn btn-info bg-primary" style="margin-left:1410px;" href="adaugare_boala.php?' . $items_add . '" class="btn btn-success">Adaugare boala</a>';?></span>
	</div>
	...
	<table class="table table-striped table-bordered mydatatable" style="width:100%; background-color:#ff794d;opacity: 0.9;">
		<thead>
			<tr>
			  ...
			  <th scope="col" style="width:200px;">Acțiuni</th>
			</tr>
		</thead>
		<tbody>
					...
					while($row = mysqli_fetch_assoc($results)){?>
						<tr>
							...
							<td>
								...
								echo '<a href="edit_action_boli.php?' . $items_edit . '"
								...
								$items = implode('&', $files);
								echo '<a href="delete_action_boli.php?' . $items . '" class="btn btn-danger">Ștergere</a>';
