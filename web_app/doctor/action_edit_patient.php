<?php if($_POST['update_patient']){
		...
		$query_update = "UPDATE pacienti SET nume='$nume', prenume='$prenume',cnp='$cnp',telefon='$telefon',adresa='$adresa',grupa_sange='$grupa_sange',rh='$rh',asigurat='$asigurat', denumire_cas='$cas', data_nastere='$data_nastere' WHERE id= $id_pacient";
