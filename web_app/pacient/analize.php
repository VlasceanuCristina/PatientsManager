...
<div class="container mb-3 mt-3">
	...
	<tbody>
		...
		// connect to database
		//$db = mysqli_connect('localhost', 'root', '', 'patients_manager');
		//ce urmeza este aprtea de inserare in baza de date care este utila dar mai tarziu
		...
		while($row=$stat->fetch()){?>
			<tr>
				...
				<td><?php echo "<a target ='_blank' href='view_analize.php?id=".$row['id']." download'>".$row['nume']."</a>"; ?></td>
