...
<head>
	...
	<nav class="navbar navbar-expand-md navbar-dark bg-primary" style="height:60px;">
		...
		<a href="acasa_pacient.php?pacient=<?php echo $_SESSION['id_pacient'];?>" class="btn btn-info btn-lg" style="background-color:white;color:blue;width:80px;height:40px;font-size:16px;"><i class="fa fa-fw fa-home"></i>Acasă</a>
		...
		<img src="<?php echo $_SESSION['poza']; ?>" title="<?php echo $_SESSION['prenume_pacient'];?>"alt="Avatar" class="avatar" style="width:40px;height:40px;border-radius: 50%;margin-left:0px;">	
	</nav>
