...
<body style ="background:url('fundal1.jpg'); no-repeat; background-size:cover;">
	...
	<form method="post" action="login.php">
		...
		<div class="input-group" style="margin: 10px 0px 10px 0px;">
			...
			<input style="height: 40px;width: 93%;padding: 5px 10pxfont-size: 16px;border-radius: 5px;border: 1px solid gray;" type="text" name="username" >
		</div>
		<div class="input-group" style="margin: 10px 0px 10px 0px;">
		...
		<div class="input-group" style="margin: 10px 0px 10px 0px;">
			<button style = "padding: 10px;font-size: 15px;color: white;background: #3498DB;border: none;border-radius: 5px;" type="submit" class="btn" name="login_user">Login</button>
		</div>
