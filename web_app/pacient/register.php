...
<body style ="background:url('fundal1.jpg'); no-repeat; background-size:cover;">
	...
	<form method="post" action="register.php">
		...
		<div class="input-group">
			<button style = "padding: 10px;font-size: 15px;color: white;background: #3498DB;border: none;border-radius: 5px;margin-top:10px;" type="submit" class="btn" name="reg_user">Inregistrare</button>
		</div>
		<p>
