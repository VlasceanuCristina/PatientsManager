...
$query="INSERT INTO internari(id_pacient,data_internare,data_externare,diagnostic_internare,diagnostic_externare) VALUES($id_pacient,'$data_internare','$data_externare','$diagnostic_internare','$diagnostic_externare')";
