...
<body style ="background:url('fundal_admin.jpg'); no-repeat; background-size:cover;resize: both;">
	...
	<form method="post" action="login.php" style="width: 30%;margin: 0px auto;padding: 20px;border: 1px solid #B0C4DE;background: white;border-radius: 0px 0px 10px 10px;opacity:0.9;">

		<?php include('errors.php'); ?>

		<div class="input-group" style="margin: 10px 0px 10px 0px;">
			<label style="display: block;text-align: left;margin: 3px;">Email</label>
			<input style="height: 40px;width: 93%;padding: 5px 10pxfont-size: 16px;border-radius: 5px;border: 1px solid gray;" type="email" name="username" >
		</div>
		<div class="input-group" style="margin: 10px 0px 10px 0px;">
			<label style="display: block;text-align: left;margin: 3px;">Parola</label>
			<input style="height: 40px;width: 93%;padding: 5px 10pxfont-size: 16px;border-radius: 5px;border: 1px solid gray;" type="password" name="password">
		</div>
		<div class="input-group" style="margin: 10px 0px 10px 0px;">
			<button  type="submit" class="btn" name="login_user" style = "padding: 10px;font-size: 15px;color: white;background: #3498DB;border: none;border-radius: 5px;">Login</button>
		</div>
	</form>
