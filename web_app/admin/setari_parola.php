<head>
	...
	<nav class="navbar navbar-expand-md navbar-dark bg-primary" style="height:60px;">
		...
		<a href="acasa_admin.php?admin=<?php echo $id_medic;?>" class="btn btn-info" style="background-color:white;color:blue;"><i class="fa fa-fw fa-home"></i>Acasă</a>
...
<div class = "card" style="margin:150px 300px 300px 300px; width:1000px;opacity: 0.9;">
	...
	<form action="parola_action.php" method="post">
		...
		<input type="hidden" name="id" value="<?php echo $id_medic;?>">
	</form>	
</div>
</body>
</html>